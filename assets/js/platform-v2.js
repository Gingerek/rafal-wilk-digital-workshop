(function(){
  ...
  const modules = [
    ...
    { match:['MSD CAO Salary Check', 'CAO Salary Check'], icon:'document', category:'documents',
      ...
      desc:{pl:'Kalkulator skali CAO, midpoint, merit matrix i minimum wage.', en:'CAO scale, midpoint, merit matrix, and minimum wage calculator.', nl:'CAO-schaal, midpoint, merit matrix en minimumloon calculator.'}},
