(function(){
  ...
  const modules = [
    ...
    { match:'Merit bulk 2026', icon:'document', category:'documents',
      title:{pl:'Merit bulk 2026', en:'Merit bulk 2026', nl:'Merit bulk 2026'},
      desc:{pl:'Bulk calculation and Excel export for employee merit rows.', en:'Bulk calculation and Excel export for employee merit rows.', nl:'Bulk calculation and Excel export for employee merit rows.'}},
