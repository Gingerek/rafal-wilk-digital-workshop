(function(){
  ...
  const modules = [
    ...
    { match:'Skanowanie duplikatów', icon:'scan', category:'recruitment',
      title:{pl:'Skanowanie duplikatów', en:'Duplicate Scanner', nl:'Duplicatenscanner'},
      desc:{pl:'Wyszukiwanie podobnych kandydatów i rekordów.', en:'Find similar candidates and duplicate records.', nl:'Vind vergelijkbare kandidaten en dubbele records.'}},
